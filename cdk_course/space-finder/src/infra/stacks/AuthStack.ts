...
export class AuthStack extends Stack {
    ...
    private createAdminGroup() {
        new CfnUserPoolGroup(this, 'SpacesAdmin', {
    ...
    private createRoles() {
        this.authenticatedRole = new Role(this, 'CodnitoDefaultAuthenticatedRole', {
        ...
        this.unAuthenticatedRole = new Role(this, 'CodnitoDefaultUnAuthenticatedRole', {
            assumedBy: new FederatedPrincipal('cognito-identity.amazonaws.com', {
                    StringEquals: {
                        'cognito-identity.amazonaws.com:aud': this.identityPool.ref
                    },
        ...
        this.adminRole = new Role(this, 'CodnitoAdminRole', {
            assumedBy: new FederatedPrincipal('cognito-identity.amazonaws.com', {
                    StringEquals: {
                        'cognito-identity.amazonaws.com:aud': this.identityPool.ref
                    },
